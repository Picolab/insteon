...
>>
  ...
  global {
    ...
    control_node = defaction(address, command) {
      node_id = process_address(address);
    ...
    process_address = function(address) {
      address.split(re/:/).join("%20")
    }

    lights = "1A:F3:3E:1"; // "1A%20F3%203E%201";
    heater = "20:B9:8F:1"; //"20%20B9%208F%201";
